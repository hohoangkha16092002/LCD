...
_0x0:
	.DB  0x41,0x75,0x74,0x6F,0x6D,0x61,0x74,0x69
	.DB  0x63,0x20,0x48,0x61,0x6E,0x64,0x0,0x57
	.DB  0x61,0x73,0x68,0x69,0x6E,0x67,0x20,0x4D
	.DB  0x61,0x63,0x68,0x69,0x6E,0x65,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0097       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0098       lcd_puts("Automatic Hand");
	__POINTW2MN _0x6,0
	RCALL _lcd_puts
; 0000 0099       lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 009A       lcd_puts("Washing Machine");
	__POINTW2MN _0x6,15
	RCALL _lcd_puts
; 0000 009B       }
	RJMP _0x3
